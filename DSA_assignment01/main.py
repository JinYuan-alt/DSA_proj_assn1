...
def login():
    ...
    while a == False:
        i+=1
        username=str(input("enter admin no./employee ID here: "))
        passwd=str(input("enter password here: "))
        print(i)
        ...
        if i>5:
            x+=1
            print("You have been locked out for ",x," minutes")
            time.sleep(60*x)
...
def add():
    ...
    if U_input == '1':
        ...
        while n == "y":
         try:
          print("Type q anywhere to exit")
          Id=int(input("enter employee id here: "))
          if Id<0:
              print("Either system error or force stop, sending you back to menu. ")
              employee_dict.update({"ID": {}})
              time.sleep(1)
              menu()
          time.sleep(0.4)
          name=input("enter name here: ")
          if name.replace(" ","").isalnum()==False or name.lower()=="q":
              print("Either system error or force stop, sending you back to menu. ")
              employee_dict.update({"ID": {}})
              time.sleep(1)
              menu()
          ...
          if Dept.replace(" ","").isalnum() == False or Dept.lower()=="q":
              print("Either system error or force stop, sending you back to menu. ")
              employee_dict.update({"ID": {}})
              time.sleep(1)
              menu()
          ...
          if title.replace(" ","").isalnum() == False or title.lower()=="q":
              print("Either system error or force stop, sending you back to menu. ")
              employee_dict.update({"ID": {}})
              time.sleep(1)
              menu()
     ...
     while loop == "y":
         try:
           ...
           loop= input("do you wish to delete more? y/n: ")
            ...
            if ValueError or KeyError:
                employee_dict.update({"ID": {}})
                print("system error or force stop, sending you back to menu. ")
                time.sleep(1)
                menu()
     menu()
